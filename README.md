...
| <a name="input_tags"></a> [tags](#input\_tags) | Additional tags to merge on top of the generated CloudPosse + ohi:* tags. At most 50 user-created tags; keys at most max\_tag\_key\_length (default 128) and values at most max\_tag\_value\_length (default 256) Unicode characters. Keys and values may only contain letters, numbers, spaces and \_ . : / = + - @. | `map(string)` | `{}` | no |
